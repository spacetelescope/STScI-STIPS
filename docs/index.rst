...
..note::
  ...
  Support for JWST and HST has been removed from the latest version of STIPS, and all instructions and documentation here reflect this change.
...
.. warning::
   ...
   STIPS JWST is no longer being actively developed except by inheriting updates to pandeia, webbpsf, and jbt (i.e. STIPS will get new throughput information, any changes to the simulated PSFs, and any changes to the simulated backgrounds). We do not test the JWST and HST portions of STIPS.
